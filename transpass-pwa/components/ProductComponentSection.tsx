      ...
      <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="12" cy="12" r="10" stroke="#3D4EAD" strokeWidth="2"/>
                </svg>
                Craftsmanship
              </Button>
              ...
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="12" cy="12" r="10" fill="white" stroke="#3D4EAD" strokeWidth="2"/>
                  <path d="M8 12L11 15L16 9" stroke="#3D4EAD" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                Slow fashion
              </Button>
        ...
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="3" y="3" width="18" height="18" rx="2" stroke="#3D4EAD" strokeWidth="2"/>
            <path d="M12 8V16" stroke="#3D4EAD" strokeWidth="2" strokeLinecap="round"/>
            <path d="M8 12H16" stroke="#3D4EAD" strokeWidth="2" strokeLinecap="round"/>
          </svg>
          Add Component
        </Button>
        ...
        <div className="flex justify-between pt-6">
          ...
          <Button 
            className="px-8 py-3 bg-primary hover:bg-primary-dark text-white font-medium rounded-full"
          >
            Next
          </Button>
        </div>
