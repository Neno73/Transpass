...
const recentActivities = [
  { id: 1, type: 'product_created', productName: 'Carbon Fiber Bicycle Frame', date: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000) },
  { id: 2, type: 'product_scanned', productName: 'Aluminum Alloy Wheelset', date: new Date(Date.now() - 36 * 60 * 60 * 1000) },
  { id: 3, type: 'component_added', productName: 'Titanium Road Bike', componentName: 'Brake System', date: new Date(Date.now() - 12 * 60 * 60 * 1000) },
  { id: 4, type: 'product_scanned', productName: 'Carbon Fiber Bicycle Frame', date: new Date(Date.now() - 4 * 60 * 60 * 1000) },
  { id: 5, type: 'product_created', productName: 'Mountain Bike Suspension Fork', date: new Date(Date.now() - 1 * 60 * 60 * 1000) },
];
        ...
        <main className="py-4 md:py-10 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-6 md:mb-8 flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
                <h1 className="text-xl md:text-2xl font-bold text-gray-dark">Dashboard</h1>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6">
                  <dl>
                    ...
                    <dd className="mt-1 text-3xl font-semibold text-gray-dark">{loading ? '...' : products.length}</dd>
                  </dl>
                </div>
                <div className="bg-primary-lightest px-4 py-4 sm:px-6">
                  <div className="text-sm">
                    <Link href="/company/products" className="font-medium text-primary hover:text-primary-dark">
                      View all products
                    </Link>
                  </div>
                </div>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6">
                  <dl>
                    ...
                    <dd className="mt-1 text-3xl font-semibold text-gray-dark">{recentActivities.length}</dd>
                  </dl>
                </div>
                <div className="bg-primary-lightest px-4 py-4 sm:px-6">
                  <div className="text-sm">
                            ...
                            <div className="min-w-0 flex-1 px-4">
                              <div>
                                ...
                                <p className="mt-1 flex items-center text-sm text-gray">
                                  <span className="truncate">{product.model || 'No model'}</span>
                                </p>
                              </div>
                            </div>
                          </div>
            ...
            <div className="mt-8 mb-16">
              <h2 className="text-lg font-medium text-gray-dark mb-4">Recent Activity</h2>
              <div className="bg-white shadow overflow-hidden rounded-md">
                <ul className="divide-y divide-gray-200">
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="ml-3">
                              <p className="text-sm font-medium text-gray-dark">
                                ...
                                {activity.type === 'product_scanned' && 'Product Scanned'}
                                {activity.type === 'component_added' && 'Component Added'}
                              </p>
                              <p className="text-sm text-gray">
                                {activity.type === 'product_created' && `Created ${activity.productName}`}
                                {activity.type === 'product_scanned' && `Someone scanned ${activity.productName}`}
                                {activity.type === 'component_added' && `Added ${activity.componentName} to ${activity.productName}`}
                              </p>
                            </div>
                          </div>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div className="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-primary">
                  ...
                  <div className="flex-1 min-w-0">
                    <Link href="/company/products/create" className="focus:outline-none">
