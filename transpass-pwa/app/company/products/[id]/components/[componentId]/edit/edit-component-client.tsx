...
export default function EditComponentClient({ id, componentId }: { id: string; componentId: string }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/company/products/${id}?tab=components`);
    } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-primary-lightest flex flex-col items-center justify-center p-4">
        <div className="bg-white p-6 rounded-xl shadow-md max-w-md w-full text-center">
          ...
          <Link href={`/company/products/${id}?tab=components`}>
          ...
          <div className="px-4 sm:px-0 mb-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <Link 
                  href={`/company/products/${id}?tab=components`}
